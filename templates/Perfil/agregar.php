                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                              ...
                              <div style="float:left" class="form-group row">
                                 ...
                                 <div class="hr-line-dashed"></div>
                              <div style="float:left;margin-top:5%" class="form-group row">
                                    <label class="col-sm-2 col-form-label">Telefono de casa</label>
                                    <div style="margin-right: 2%;" class="col-sm-4">
                                    <input value="<?php echo $tel ?>" style="width:100%" type="textarea" class="form-control" name="telefono" required>
                                    </div>
                                </div>
