                    ...
                    <div class="ibox ">
                        ...
                        <div>
                            <div class="ibox-content no-padding border-left-right">
                                <img alt="image" class="img-fluid" src="/webroot/img/profile_big.jpg">
                            </div>
                            <div class="ibox-content profile-content">
                                ...
                                <div style="margin-bottom:30px;" class="row m-t-lg">
                                    <div class="col-md-4">
                                ...
                                <div class="user-button">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <button style="font-size:14px" type="button" class="btn btn-default btn-sm btn-block"><i class="fa fa-eye"></i> Ver Perfil</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
