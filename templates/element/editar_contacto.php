                ...
                <main>
                             ...
                             <div class="col-lg-12"> 
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4"><input value="<?php echo $row['apellido_materno']?>" type="text" placeholder="Apellido Materno" class="form-control required" name="apellido_materno" ></div>    
                    ...
                    <div class="col-lg-12" style="float: left;background-color: #ffffff;color: inherit;border-top-color: #e7eaec; border-image: inherit;border-top-style: solid;border-top-width: 1px;">
                                ...
                                <div class="form-group row" style="margin-bottom:0px"><label class="col-sm-1 col-form-label">Dirección</label>
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <input value="<?php echo $row['pais']?>" style="width: 20%;float: left;margin-left: 2%;" type="text" class="form-control" name="pais" placeholder="Pais" >
                                    </div>
                                </div>
