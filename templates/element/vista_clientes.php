...
$query = $clientes->find();    
             ...
             <header></header>
              <div class="wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <buton href="#victorModal5" data-toggle="modal" class="btn btn-primary editar"><i class="fa fa-pencil"></i> Editar</buton>
                     <a href="/clientes/delete?var=<?php echo $_REQUEST['var']?>" class="btn btn-danger delete"><i class="fa fa-trash"></i> Eliminar</a>
                </div>
    ...
    margin-left: 27px;height: 100px;" alt="image" class="rounded-circle" src="<?php 
                ...
                <main class="col-sm-1.5" style="float:left;margin-top:15px">
                ...
                <main style="float:left;margin-top:15px" class="col-sm-2">
                             ...
                             <div style="border-left-style: outset;" > 
                               <div style="margin-left:6px">
                                 <div class="">
                                    <h3><?php echo $row['nombre_comercial']?> </h3>
                                    </div> 
                                      <div class="">
                                    <h3><?php echo $row['razon_social']?> </h3>
                                    </div> 
                                <div class="">
                             ...
                             <div style="border-left-style: outset;" > 
                               <div style="margin-left:6px">
                                    ...
                                    <h3><?php if($row['tipo_persona']==1){
                                       ...
                                       <div class="">
                                    <h3><?php if($row['pagina_web']==null){echo "N/A"; }else echo $row['pagina_web']?> </h3>
                                    </div>
...
<div id="victorModal5" class="modal fade">
    ...
    margin: 21.75rem auto">
        <div class="modal-content">
            ...
            <div>
               ...
               <?php
                echo $this->element('editar_cliente');
