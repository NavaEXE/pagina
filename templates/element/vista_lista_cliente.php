        ...
        <div class="row tabla-contacto-lista">
            <?php foreach ($query as $row) {
                if($row['status']==1){
                        ...
                        ?>"> </td>
                                                    <td><a href="/directorio/clientes/cliente?var=<?php echo base64_encode($row['id'])?>" class="client-link"><?php echo $row['nombre']?> <?php echo $row['apellido_paterno']?> <?php echo $row['apellido_materno']?></a></td>
